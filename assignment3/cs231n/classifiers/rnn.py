...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            ...
            h, lstm_cache = lstm_forward(embed_out, affine_out, Wx, Wh, b)
        # 4
        ...
        if self.cell_type == 'rnn':
            ...
            dembed_out, daffine_out, grads["Wx"], grads["Wh"], grads["b"] = lstm_backward(dh, lstm_cache)
        # 2 
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length):
          ...
          # pick the index of highest scores
